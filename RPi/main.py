...
try:
    #check OPD value
    while(1):
        inval = input("Please enter the value of OPD: ")
        OPD = int(inval)
        if (OPD >= 0 and OPD < 5):
            print("Please turn on the light more to work hard!")
        else:
            print("You have a great environment:D ")
            print("Let's get started. The cushion is on!")
            time.sleep(2)
            break
